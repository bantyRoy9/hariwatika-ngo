...
export default function RegistrationPage() {
      ...
      <html>
        <head>
          ...
          <style>
            ...
            h1 { font-family: 'Literata', serif; color: ${LENITY.accent}; margin: 0 0 4px; font-size: 22px; }
            ...
            .avatar { width: 80px; height: 80px; border: 2px solid ${LENITY.accent}; border-radius: 8px; background: ${LENITY.accentSoft}; display: flex; align-items: center; justify-content: center; color: ${LENITY.accent}; font-size: 24px; font-weight: bold; float: right; margin-left: 12px; font-family: 'Literata', serif; }
            .section-title { font-family: 'Literata', serif; font-size: 14px; font-weight: 700; color: ${LENITY.accent}; margin: 14px 0 8px; border-left: 3px solid ${LENITY.accent}; padding-left: 8px; }
            .reg-id { font-size: 10px; font-weight: bold; color: ${LENITY.accent}; }
          </style>
        </head>
        <body>
          <div class="header">
  ...
  const inputClass = "w-full border rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none transition-colors";
    ...
    <>
      ...
      <main>
        ...
        <section className="relative pt-28 pb-20 overflow-hidden">
          <img
            src={IMG.hero}
            alt="Couples blessed at a Hariwatika mass marriage ceremony"
            className="absolute inset-0 w-full h-full object-cover"
            loading="eager"
          />
          <div
            className="absolute inset-0"
            style={{ background: "linear-gradient(90deg, rgba(15,10,5,0.85) 0%, rgba(15,10,5,0.62) 45%, rgba(15,10,5,0.2) 80%, transparent 100%)" }}
          />
            ...
            {submitted[tab] ? (
              ...
              >
                <div className="p-6 text-center text-white" style={{ background: LENITY.accent }}>
                  ...
                  <p className="text-white/85 text-sm">ID: {regId[tab]}</p>
                </div>
                <div className="p-6">
                  {/* Print-ready content */}
              ...
              >
                <form onSubmit={handleSubmit} className="space-y-5">
                  <h3 className={sectionHeadingClass} style={{ color: LENITY.accent, borderColor: LENITY.line }}>
                  ...
                  <h3 className={`${sectionHeadingClass} pt-2`} style={{ color: LENITY.accent, borderColor: LENITY.line }}>
                    Family Information
                  </h3>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        <User className="w-5 h-5" style={{ color: LENITY.accent }} />
                      </span>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full text-white rounded-full py-4 font-bold transition-all hover:scale-[1.02] disabled:opacity-60 disabled:hover:scale-100 flex items-center justify-center gap-2"
                    style={{ background: LENITY.accent }}
                  >
                    {loading ? (
