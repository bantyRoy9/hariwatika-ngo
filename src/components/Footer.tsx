        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#855300]">
                <Heart className="w-5 h-5 text-white fill-white" />
              </span>
              <span
                className="text-xl font-bold text-[#F4A433]"
            ...
            <p
              className="text-[#F4A433] font-semibold mb-2"
              style={{ fontFamily: "'Literata', Georgia, serif" }}
            >
              सेवा ही धर्म है
            </p>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#855300] flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-[#F4A433] text-sm transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex gap-3">
                <MapPin className="w-4 h-4 text-[#F4A433] mt-0.5 flex-shrink-0" />
              ...
              <li className="flex gap-3 items-center">
                <Phone className="w-4 h-4 text-[#F4A433] flex-shrink-0" />
              ...
              <li className="flex gap-3 items-center">
                <Mail className="w-4 h-4 text-[#F4A433] flex-shrink-0" />
                <a
                  href="mailto:hariwatikaseva@gmail.com"
                  className="text-gray-400 hover:text-[#F4A433] text-sm transition-colors break-all"
                >
            ...
            <div className="mt-4 rounded-xl overflow-hidden bg-white/5 border border-white/10">
              <div className="w-full h-28 flex items-center justify-center text-gray-500 text-xs">
                <div className="text-center">
                  <MapPin className="w-6 h-6 text-[#F4A433] mx-auto mb-1" />
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <p className="text-gray-600 text-xs flex items-center gap-1">
            Made with <Heart className="w-3 h-3 text-[#F4A433] fill-[#F4A433]" /> for community service
          </p>
        </div>
      </div>
    </footer>
