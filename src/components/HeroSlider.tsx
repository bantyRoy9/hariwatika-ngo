...
const slides: Slide[] = [
  {
    id: 1,
    image: IMG.helpers1,
    eyebrow: { en: "Our Helpers", hi: "हमारे सहायक" },
    line1: { en: "Our", hi: "हमारे" },
    line2: { en: "Helpers.", hi: "सहायक।" },
    tagline: { en: "The dedicated team and volunteers who deliver our mission every day.", hi: "हर दिन हमारे मिशन को साकार करने वाली समर्पित टीम और स्वयंसेवक।" },
    description: { en: "From healthcare camps to tree plantations, our helpers are the hands and hearts behind every initiative across West Champaran.", hi: "स्वास्थ्य शिविरों से लेकर वृक्षारोपण तक, पश्चिम चम्पारण में हर पहल के पीछे हमारे सहायकों का हाथ और दिल है।" },
  },
  {
    id: 2,
    image: IMG.donors1,
    eyebrow: { en: "Our Donors", hi: "हमारे दाता" },
    line1: { en: "Our", hi: "हमारे" },
    line2: { en: "Donors.", hi: "दाता।" },
    tagline: { en: "Generous supporters whose kindness makes our work possible.", hi: "उदार समर्थक जिनकी दयालुता से हमारा काम संभव होता है।" },
    description: { en: "Every contribution — big or small — brings dignity, healthcare, and hope to families across Bihar.", hi: "हर योगदान — चाहे बड़ा हो या छोटा — बिहार के परिवारों को सम्मान, स्वास्थ्य और आशा देता है।" },
  },
  {
    id: 3,
    image: IMG.helpers2,
  ...
  },
  {
    ...
    line1: { en: "Our", hi: "हमारे" },
    line2: { en: "Donors.", hi: "दाता।" },
    tagline: { en: "Generous supporters whose kindness makes our work possible.", hi: "उदार समर्थक जिनकी दयालुता से हमारा कार्य संभव होता है।" },
    description: { en: "Every contribution — big or small — brings dignity, healthcare, and hope to families across Bihar.", hi: "हर योगदान — चाहे बड़ा हो या छोटा — बिहार के परिवारों को सम्मान, स्वास्थ्य और आशा देता है।" },
  },
];
